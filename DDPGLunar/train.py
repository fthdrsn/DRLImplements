...
def main(args):
    ...
    for e in range(args.numberOfEpisode):
        ...
        for s in range(args.maxStepCount):
            ...
            action=np.clip(ddpgAgent.GetAction(state)+noise.EvolveState(),actionL,actionH)
...
if __name__=="__main__":
    ...
    parser.add_argument("--maxStepCount", type=int, default=3000000, help="Maximum step count in an episode")
    ...
    parser.add_argument("--theta", default=0.4, help="Start value of epsilon  ")
    parser.add_argument("--startSigma", default=0.2, help="Start value of epsilon  ")
